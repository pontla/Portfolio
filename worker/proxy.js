...
function normalizeQuoteSummary(symbol, r) {
    ...
    return {
        ...
        regularMarketVolume: rawNum(pr.regularMarketVolume) ?? rawNum(sd.volume),
        averageVolume: rawNum(sd.averageVolume) ?? rawNum(sd.averageDailyVolume3Month),
        averageVolume10Days: rawNum(sd.averageVolume10days) ?? rawNum(sd.averageDailyVolume10Day),
